...
class $AssetsIconsGen {
  ...
  String get squares => 'assets/icons/squares.svg';

  /// File path: assets/icons/write.svg
...
class $AssetsImagesGen {
  ...
  /// File path: assets/images/illuminate_post.png
  AssetGenImage get illuminatePost =>
      const AssetGenImage('assets/images/illuminate_post.png');

  /// List of all assets
  List<AssetGenImage> get values => [illuminatePost];
}
